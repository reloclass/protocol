...
type Suspend struct {
	...
	UserName int64 `protobuf:"varint,4,opt,name=user_name,json=userName,proto3" json:"supervisorName"`
	// 中止原因
...
func (x *Suspend) GetUserName() int64 {
	if x != nil {
		return x.UserName
	}
	return 0
...
var file_relo_protocol_vo_suspend_proto_rawDesc = []byte{
	...
	0x6e, 0x61, 0x6d, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x75, 0x73, 0x65, 0x72,
