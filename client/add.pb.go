...
type AddRsp struct {
	...
	// 客户端编号
	// @gotags: json:"id,string,omitempty" param:"id"
	Id int64 `protobuf:"varint,1,opt,name=id,proto3" json:"id,string,omitempty" param:"id"`
}
...
var file_relo_protocol_client_add_proto_rawDesc = []byte{
	...
	0x0c, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x64, 0x65, 0x73, 0x63, 0x18, 0x03, 0x20,
	...
	0x64, 0x35, 0x12, 0x36, 0x0a, 0x0b, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x74, 0x79, 0x70,
