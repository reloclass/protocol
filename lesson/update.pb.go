...
type UpdateReq struct {
	...
	AllowedType schedule.AllowedType `protobuf:"varint,9,opt,name=allowed_type,json=allowedType,proto3,enum=relo.core.schedule.AllowedType" json:"allowedType" default:"1" validate:"omitempty,oneof=1 2 3"`
	// 是否需要验证码
	...
	RecordType schedule.RecordType `protobuf:"varint,11,opt,name=record_type,json=recordType,proto3,enum=relo.core.schedule.RecordType" json:"recordType" default:"1" validate:"omitempty,oneof=1 2 3"`
	// 课程计划教学资料
	...
	LiveAllowedType schedule.LiveAllowedType `protobuf:"varint,13,opt,name=live_allowed_type,json=liveAllowedType,proto3,enum=relo.core.schedule.LiveAllowedType" json:"liveAllowedType" validate:"required,oneof=1 2"`
	// 视频质量
	// @gotags: json:"videoDimension" validate:"required,oneof=1 2 3"
	VideoDimensionType schedule.VideoDimensionType `protobuf:"varint,14,opt,name=video_dimension_type,json=videoDimensionType,proto3,enum=relo.core.schedule.VideoDimensionType" json:"videoDimension" validate:"required,oneof=1 2 3"`
	// 上台人数
...
type UpdateStartingReq struct {
	...
	// 录制操作类型
	// @gotags: default:"1" json:"recordType" validate:"omitempty,oneof=1 2 3"
	RecordType schedule.RecordType `protobuf:"varint,5,opt,name=record_type,json=recordType,proto3,enum=relo.core.schedule.RecordType" json:"recordType" default:"1" validate:"omitempty,oneof=1 2 3"`
	// 是否允许直播
	// @gotags: json:"liveAllowedType" validate:"required,oneof=1 2"
	LiveAllowedType schedule.LiveAllowedType `protobuf:"varint,6,opt,name=live_allowed_type,json=liveAllowedType,proto3,enum=relo.core.schedule.LiveAllowedType" json:"liveAllowedType" validate:"required,oneof=1 2"`
}
...
func (x *UpdateStartingReq) GetRecordType() schedule.RecordType {
	if x != nil {
		return x.RecordType
	}
	return schedule.RecordType_RECORD_TYPE_UNSPECIFIED
...
func (x *UpdateStartingReq) GetLiveAllowedType() schedule.LiveAllowedType {
	if x != nil {
		return x.LiveAllowedType
	}
	return schedule.LiveAllowedType_LIVE_ALLOWED_TYPE_UNSPECIFIED
...
var file_relo_protocol_lesson_update_proto_rawDesc = []byte{
	...
	0x6f, 0x6c, 0x2e, 0x6c, 0x65, 0x73, 0x73, 0x6f, 0x6e, 0x1a, 0x25, 0x72, 0x65, 0x6c, 0x6f, 0x2f,
	0x63, 0x6f, 0x72, 0x65, 0x2f, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x2f, 0x61, 0x6c,
	0x6c, 0x6f, 0x77, 0x65, 0x64, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x1a, 0x24, 0x72, 0x65, 0x6c, 0x6f, 0x2f, 0x63, 0x6f, 0x72, 0x65, 0x2f, 0x73, 0x63, 0x68, 0x65,
	...
	0x5f, 0x74, 0x79, 0x70, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x90, 0x05, 0x0a, 0x09,
	...
	0x08, 0x64, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x42, 0x0a, 0x0c, 0x61, 0x6c, 0x6c,
	...
	0x69, 0x72, 0x65, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x08, 0x52, 0x11, 0x69, 0x73, 0x43, 0x61,
	...
	0x0a, 0x09, 0x6d, 0x61, 0x74, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x73, 0x18, 0x0c, 0x20, 0x03, 0x28,
	...
	0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x23, 0x2e, 0x72, 0x65,
	...
	0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0e, 0x32,
	...
	0x05, 0x52, 0x0b, 0x73, 0x74, 0x61, 0x74, 0x65, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x22, 0x8b,
	...
	,
}
...
var file_relo_protocol_lesson_update_proto_goTypes = []interface{}{
	...
	(schedule.AllowedType)(0),        // 2: relo.core.schedule.AllowedType
	(schedule.RecordType)(0),         // 3: relo.core.schedule.RecordType
...
var file_relo_protocol_lesson_update_proto_depIdxs = []int32{
	2, // 0: relo.protocol.lesson.UpdateReq.allowed_type:type_name -> relo.core.schedule.AllowedType
	3, // 1: relo.protocol.lesson.UpdateReq.record_type:type_name -> relo.core.schedule.RecordType
	4, // 2: relo.protocol.lesson.UpdateReq.materials:type_name -> relo.protocol.vo.TeachingMaterial
	5, // 3: relo.protocol.lesson.UpdateReq.live_allowed_type:type_name -> relo.core.schedule.LiveAllowedType
	6, // 4: relo.protocol.lesson.UpdateReq.video_dimension_type:type_name -> relo.core.schedule.VideoDimensionType
	4, // 5: relo.protocol.lesson.UpdateStartingReq.materials:type_name -> relo.protocol.vo.TeachingMaterial
	3, // 6: relo.protocol.lesson.UpdateStartingReq.record_type:type_name -> relo.core.schedule.RecordType
	5, // 7: relo.protocol.lesson.UpdateStartingReq.live_allowed_type:type_name -> relo.core.schedule.LiveAllowedType
