...
func (x *GetReq) Reset() {
	*x = GetReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_relo_protocol_homework_assigned_get_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetReq) Descriptor() ([]byte, []int) {
	return file_relo_protocol_homework_assigned_get_proto_rawDescGZIP(), []int{2}
}
...
var file_relo_protocol_homework_assigned_get_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x42, 0x3a, 0x5a, 0x38, 0x67, 0x69, 0x74, 0x68, 0x75,
	...
	0x6b, 0x2f, 0x61, 0x73, 0x73, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x3b, 0x61, 0x73, 0x73, 0x69, 0x67,
...
var file_relo_protocol_homework_assigned_get_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_relo_protocol_homework_assigned_get_proto_goTypes = []interface{}{
	...
	(*GetReq)(nil),              // 2: relo.protocol.homework.assigned.GetReq
...
var file_relo_protocol_homework_assigned_get_proto_depIdxs = []int32{
	3, // 0: relo.protocol.homework.assigned.GetsByPagingRsp.items:type_name -> relo.protocol.vo.AssignedHomework
...
func file_relo_protocol_homework_assigned_get_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_relo_protocol_homework_assigned_get_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetReq); i {
			case 0:
				return &v.state
			case 1:
