...
// 获取用户参与的课程请求
type GetsUsersByPagingReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetsUsersByPagingReq) Reset() {
	*x = GetsUsersByPagingReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_relo_protocol_course_get_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GetsUsersByPagingReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetsUsersByPagingReq) ProtoMessage() {}

func (x *GetsUsersByPagingReq) ProtoReflect() protoreflect.Message {
	mi := &file_relo_protocol_course_get_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetsUsersByPagingReq.ProtoReflect.Descriptor instead.
func (*GetsUsersByPagingReq) Descriptor() ([]byte, []int) {
	return file_relo_protocol_course_get_proto_rawDescGZIP(), []int{3}
}

func (x *GetsUsersByPagingReq) GetPage() int32 {
	if x != nil {
		return x.Page
	}
	return 0
...
func (x *GetsUsersByPagingReq) GetSize() int32 {
	if x != nil {
		return x.Size
	}
	return 0
...
func (x *GetsUsersByPagingReq) GetKeyword() string {
	if x != nil {
		return x.Keyword
	}
	return ""
...
func (x *GetsUsersByPagingReq) GetOrder() string {
	if x != nil {
		return x.Order
	}
	return ""
...
func (x *GetsUsersByPagingReq) GetSort() string {
	if x != nil {
		return x.Sort
	}
	return ""
...
// 获取用户参与的课程响应
type GetsUsersByPagingRsp struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetsUsersByPagingRsp) Reset() {
	*x = GetsUsersByPagingRsp{}
	if protoimpl.UnsafeEnabled {
		mi := &file_relo_protocol_course_get_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GetsUsersByPagingRsp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetsUsersByPagingRsp) ProtoMessage() {}

func (x *GetsUsersByPagingRsp) ProtoReflect() protoreflect.Message {
	mi := &file_relo_protocol_course_get_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetsUsersByPagingRsp.ProtoReflect.Descriptor instead.
func (*GetsUsersByPagingRsp) Descriptor() ([]byte, []int) {
	return file_relo_protocol_course_get_proto_rawDescGZIP(), []int{4}
}

func (x *GetsUsersByPagingRsp) GetTotalNum() int64 {
	if x != nil {
		return x.TotalNum
	}
	return 0
...
func (x *GetsUsersByPagingRsp) GetItems() []*vo.UserCourse {
	if x != nil {
		return x.Items
	}
	return nil
...
var file_relo_protocol_course_get_proto_rawDesc = []byte{
	...
	0x6f, 0x63, 0x6f, 0x6c, 0x2f, 0x76, 0x6f, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x63, 0x6f, 0x75,
	0x72, 0x73, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x18, 0x0a, 0x06, 0x47, 0x65, 0x74,
	0x52, 0x65, 0x71, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x02, 0x69, 0x64, 0x22, 0xe1, 0x02, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x73, 0x42, 0x79, 0x50, 0x61,
	...
	0x6f, 0x72, 0x74, 0x12, 0x2c, 0x0a, 0x05, 0x74, 0x79, 0x70, 0x65, 0x73, 0x18, 0x07, 0x20, 0x03,
	0x28, 0x0e, 0x32, 0x16, 0x2e, 0x72, 0x65, 0x6c, 0x6f, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x63,
	0x6f, 0x75, 0x72, 0x73, 0x65, 0x2e, 0x54, 0x79, 0x70, 0x65, 0x52, 0x05, 0x74, 0x79, 0x70, 0x65,
	...
	0x0a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x65, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x3a,
	0x0a, 0x0a, 0x63, 0x6c, 0x61, 0x73, 0x73, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x18, 0x0b, 0x20, 0x01,
	...
	0x09, 0x63, 0x6c, 0x61, 0x73, 0x73, 0x4d, 0x6f, 0x64, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x73, 0x63,
	0x68, 0x6f, 0x6f, 0x6c, 0x5f, 0x69, 0x64, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x73,
	0x63, 0x68, 0x6f, 0x6f, 0x6c, 0x49, 0x64, 0x22, 0x5e, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x73, 0x42,
	...
	0x6f, 0x74, 0x61, 0x6c, 0x4e, 0x75, 0x6d, 0x12, 0x2e, 0x0a, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73,
	0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x72, 0x65, 0x6c, 0x6f, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x2e, 0x76, 0x6f, 0x2e, 0x43, 0x6f, 0x75, 0x72, 0x73, 0x65,
	0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x22, 0x82, 0x01, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x73,
	0x55, 0x73, 0x65, 0x72, 0x73, 0x42, 0x79, 0x50, 0x61, 0x67, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x71,
	...
	0x72, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x05, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x73, 0x6f, 0x72, 0x74,
	0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x73, 0x6f, 0x72, 0x74, 0x22, 0x67, 0x0a, 0x14,
	0x47, 0x65, 0x74, 0x73, 0x55, 0x73, 0x65, 0x72, 0x73, 0x42, 0x79, 0x50, 0x61, 0x67, 0x69, 0x6e,
	...
	0x6d, 0x12, 0x32, 0x0a, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x1c, 0x2e, 0x72, 0x65, 0x6c, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c,
	0x2e, 0x76, 0x6f, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x43, 0x6f, 0x75, 0x72, 0x73, 0x65, 0x52, 0x05,
	0x69, 0x74, 0x65, 0x6d, 0x73, 0x42, 0x2d, 0x5a, 0x2b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
	0x63, 0x6f, 0x6d, 0x2f, 0x72, 0x65, 0x6c, 0x6f, 0x63, 0x6c, 0x61, 0x73, 0x73, 0x2f, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x2f, 0x63, 0x6f, 0x75, 0x72, 0x73, 0x65, 0x3b, 0x63, 0x6f,
...
var file_relo_protocol_course_get_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_relo_protocol_course_get_proto_goTypes = []interface{}{
	...
	(*GetsUsersByPagingReq)(nil), // 3: relo.protocol.course.GetsUsersByPagingReq
	(*GetsUsersByPagingRsp)(nil), // 4: relo.protocol.course.GetsUsersByPagingRsp
	(course.Type)(0),             // 5: relo.core.course.Type
	(course.ClassMode)(0),        // 6: relo.core.course.ClassMode
	(*vo.Course)(nil),            // 7: relo.protocol.vo.Course
	(*vo.UserCourse)(nil),        // 8: relo.protocol.vo.UserCourse
}
var file_relo_protocol_course_get_proto_depIdxs = []int32{
	5, // 0: relo.protocol.course.GetsByPagingReq.types:type_name -> relo.core.course.Type
	6, // 1: relo.protocol.course.GetsByPagingReq.class_mode:type_name -> relo.core.course.ClassMode
	7, // 2: relo.protocol.course.GetsByPagingRsp.items:type_name -> relo.protocol.vo.Course
	8, // 3: relo.protocol.course.GetsUsersByPagingRsp.items:type_name -> relo.protocol.vo.UserCourse
...
func file_relo_protocol_course_get_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_relo_protocol_course_get_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetsUsersByPagingReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_relo_protocol_course_get_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetsUsersByPagingRsp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
