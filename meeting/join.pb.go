...
type JoinReq struct {
	...
	UserId int64 `protobuf:"varint,2,opt,name=userId,proto3" json:"userId" validate:"required"`
	// 课时时刻编号
	// @gotags: json:"courseTimeId,string" validate:"required"
	CourseTimeId int64 `protobuf:"varint,3,opt,name=courseTimeId,proto3" json:"courseTimeId,string" validate:"required"`
}
...
type JoinRsp struct {
	...
	AppId int64 `protobuf:"varint,2,opt,name=appId,proto3" json:"appId,string"`
	// 用户编号 如果是游客则返回一个虚拟的号
	// @gotags: json:"userId,string"
	UserId int64 `protobuf:"varint,3,opt,name=userId,proto3" json:"userId,string"`
	// 加入课程中 会议时用户名字
...
var file_relo_protocol_meeting_join_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x45, 0x0a,
	0x07, 0x4a, 0x6f, 0x69, 0x6e, 0x52, 0x65, 0x71, 0x12, 0x16, 0x0a, 0x06, 0x75, 0x73, 0x65, 0x72,
	0x49, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64,
	0x12, 0x22, 0x0a, 0x0c, 0x63, 0x6f, 0x75, 0x72, 0x73, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x49, 0x64,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0c, 0x63, 0x6f, 0x75, 0x72, 0x73, 0x65, 0x54, 0x69,
	0x6d, 0x65, 0x49, 0x64, 0x22, 0xb6, 0x02, 0x0a, 0x07, 0x4a, 0x6f, 0x69, 0x6e, 0x52, 0x73, 0x70,
