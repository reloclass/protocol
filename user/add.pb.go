...
var file_relo_protocol_user_add_proto_rawDesc = []byte{
	...
	0x72, 0x52, 0x0a, 0x65, 0x78, 0x69, 0x73, 0x74, 0x55, 0x73, 0x65, 0x72, 0x73, 0x42, 0x29, 0x5a,
...
var file_relo_protocol_user_add_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_relo_protocol_user_add_proto_goTypes = []interface{}{
	...
	(*vo.User)(nil),     // 3: relo.protocol.vo.User
}
var file_relo_protocol_user_add_proto_depIdxs = []int32{
	1, // 0: relo.protocol.user.AddReq.users:type_name -> relo.protocol.user.User
	3, // 1: relo.protocol.user.BatchAddRsp.repeat_users:type_name -> relo.protocol.vo.User
	3, // 2: relo.protocol.user.BatchAddRsp.err_users:type_name -> relo.protocol.vo.User
	3, // 3: relo.protocol.user.BatchAddRsp.exist_users:type_name -> relo.protocol.vo.User
