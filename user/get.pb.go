...
var file_relo_protocol_user_get_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_relo_protocol_user_get_proto_goTypes = []interface{}{
	...
	(*vo.User)(nil),         // 2: relo.protocol.vo.User
}
var file_relo_protocol_user_get_proto_depIdxs = []int32{
	2, // 0: relo.protocol.user.GetsByPagingRsp.items:type_name -> relo.protocol.vo.User
